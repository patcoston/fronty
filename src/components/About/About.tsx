...
const About: FC = () => {
  return (
    <div className="about">
      <h3>About Fronty:</h3>
      <section>
        Fronty is an attempt to improve job-search for front-end web-developers.
        This is a recruiter-free zone. You connect directly with the companies.
        No middleman!
      </section>
      <section>
        Fronty lets you filter your search results more accurately than any
      ...
      <section>
        10 Examples of filters Fronty has that others don't.
        <ol>
