export const SHOW_FILTER_ACCESSIBLE: number = 0
export const SHOW_FILTER_BENEFITS: number = 1
export const SHOW_FILTER_COMMUTE: number = 2
export const SHOW_FILTER_COMPANY: number = 3
export const SHOW_FILTER_COMPANY_SIZE: number = 4
export const SHOW_FILTER_DRESS_CODE: number = 5
export const SHOW_FILTER_EDUCATION_REQUIRED: number = 6
export const SHOW_FILTER_EMPLOYEE_TYPE: number = 7
export const SHOW_FILTER_EXPERIENCE_LEVEL: number = 8
export const SHOW_FILTER_INDUSTRY: number = 9
...
export const SHOW_FILTER_PAYMENT: number = 13
export const SHOW_FILTER_PETS_ALLOWED: number = 14
export const SHOW_FILTER_SKILL: number = 15
...
export const PATH_BASE: string = "/portfolio/fronty/"
...
export const PATH_SHOW_JOB: string = PATH_BASE + "job"
